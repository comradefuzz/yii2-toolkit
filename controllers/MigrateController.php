<?php
namespace ladno\yii2toolkit\controllers;

use Yii;
use yii\helpers\ArrayHelper;

/**
 * Extended MigrateController for module stored migrations support
 *
 * Usage:
 * Add controller to `controllerMap` of your console application and define paths in `migrationLookup` array
 *
 * @author Fuzz <comrade.fuzzz@gmail.com>
